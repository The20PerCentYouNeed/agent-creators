...
@section('content')
                    ...
                    <div class="p-4 md:p-6 rounded-xl bg-gradient-to-br from-blue-950/30 to-blue-900/20 border border-blue-800">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-start gap-3">
                                <x-heroicon-o-check-circle class="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" />
                                <div>
                                    <span class="font-semibold text-white">{{ __('Industry') }}:</span>
                                    <span class="text-gray-300 ml-2">{{ __('Distribution & Wholesale') }}</span>
                                </div>
                            </div>
                            <div class="flex items-start gap-3">
                                <x-heroicon-o-check-circle class="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" />
                                <div>
                                    <span class="font-semibold text-white">{{ __('Implementation Duration') }}:</span>
                                    <span class="text-gray-300 ml-2">{{ __('5 weeks') }}</span>
                                </div>
                            </div>
                            <div class="flex items-start gap-3">
                                <x-heroicon-o-check-circle class="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" />
                                <div>
                                    <span class="font-semibold text-white">{{ __('Goal') }}:</span>
                                    <span class="text-gray-300 ml-2">{{ __('Optimize procurement costs through intelligent policy application') }}</span>
                                </div>
                            </div>
                            <div class="flex items-start gap-3">
                                <x-heroicon-o-check-circle class="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" />
                                <div>
                                    <span class="font-semibold text-white">{{ __('Technology') }}:</span>
                                    <span class="text-gray-300 ml-2">{{ __('Custom AI Agent with ERP integration') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="py-12 md:py-20 px-4 sm:px-6 lg:px-8 bg-gray-950">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-gradient-to-br from-gray-800 to-gray-900/20 rounded-2xl p-4 md:p-8 border border-gray-700">
                ...
                <h3 class="text-lg md:text-xl font-bold text-white mb-4">{{ __('Critical gaps identified') }}:</h3>
                <ul class="space-y-3">
                    <li class="flex items-start gap-3">
                        <x-heroicon-o-x-circle class="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
                        <span class="text-gray-300">{{ __('Volume discount thresholds (e.g., -3% for 12+ boxes, -5% for 24+).') }}</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <x-heroicon-o-x-circle class="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
                        <span class="text-gray-300">{{ __('Promotional offers (1+1, free shipping, pallet discounts).') }}</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <x-heroicon-o-x-circle class="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
                        <span class="text-gray-300">{{ __('Supplier-specific policies stored in PDF documents.') }}</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <x-heroicon-o-x-circle class="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
                        <span class="text-gray-300">{{ __('Layer/pallet optimization opportunities.') }}</span>
                    </li>
                </ul>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-gray-800 rounded-2xl p-8 border border-gray-700 mb-8">
                ...
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h3 class="text-lg md:text-xl font-bold text-white">{{ __('Proposed Implementation Plan') }}</h3>
                </div>

                <div class="space-y-6">
                    <div class="flex gap-4">
                        <div class="flex-shrink-0 w-8 h-8 bg-blue-900/30 rounded-full flex items-center justify-center">
                            <span class="text-blue-400 font-bold">1</span>
                        </div>
                        <div>
                            <h4 class="font-bold text-white mb-2">{{ __('Environment Setup & Agent Definition (Week 1)') }}</h4>
                            <p class="text-gray-300">{{ __('Establish the AI workspace, define business rules for discount thresholds, 1+1 offers, pallet optimization, and supplier priorities. Create the foundational logic that would guide the Agent\'s decision-making process.') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="font-bold text-white mb-2">{{ __('Commercial Policy Processing (Week 1, parallel)') }}</h4>
                            <p class="text-gray-300">{{ __('Test PDF parsing with 2-3 supplier policies. Develop standardized "clean PDF" templates to ensure accurate rule extraction. Convert policy documents into structured rules the Agent can apply.') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="font-bold text-white mb-2">{{ __('ERP Integration (Weeks 2-3)') }}</h4>
                            <p class="text-gray-300">{{ __('Collaborate with vendor to establish read-only API or database access. Connect Agent to auto-orders table and supplier policy PDFs. Test real-time data flow and connectivity.') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="font-bold text-white mb-2">{{ __('Chatbot Interface & Reporting (Weeks 3-4, parallel)') }}</h4>
                            <p class="text-gray-300">{{ __('Build web-based chatbot widget that would display Agent recommendations with full justification. Implement accept/reject feedback mechanism. Create reporting dashboard for tracking savings and performance.') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="font-bold text-white mb-2">{{ __('Testing & Final Delivery (Week 5)') }}</h4>
                            <p class="text-gray-300">{{ __('Conduct testing with actual auto-orders. Refine integration and business rules based on results. Deliver fully operational system with comprehensive documentation and training.') }}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-12 md:py-20 px-4 sm:px-6 lg:px-8 bg-gray-950">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-gray-900 rounded-2xl p-4 md:p-8 border border-gray-700">
                <h3 class="text-lg md:text-xl font-bold text-white mb-6">{{ __('The Agent\'s Process') }}:</h3>
                ...
                <div class="grid md:grid-cols-3 gap-6">
                    <div class="bg-gray-800 rounded-xl p-4 md:p-6 border border-gray-700">
                        ...
                        <h4 class="font-bold text-white mb-2">{{ __('Read') }}</h4>
                        <p class="text-gray-300">{{ __('Monitors automated ordering system for new orders. Reads product codes, quantities, unit prices, and supplier data.') }}</p>
                    </div>
                    ...
                    <div class="bg-gray-800 rounded-xl p-4 md:p-6 border border-gray-700">
                        ...
                        <h4 class="font-bold text-white mb-2">{{ __('Analyze') }}</h4>
                        <p class="text-gray-300">{{ __('Applies relevant supplier commercial policies. Calculates volume discounts, promotional offers, and pallet optimizations.') }}</p>
                    </div>

                    <div class="bg-gray-800 rounded-xl p-4 md:p-6 border border-gray-700">
                        <div class="w-12 h-12 bg-blue-900/30 rounded-lg flex items-center justify-center mb-4">
                            <x-heroicon-o-light-bulb class="w-6 h-6 text-blue-400" />
                        </div>
                        <h4 class="font-bold text-white mb-2">{{ __('Recommend') }}</h4>
                        <p class="text-gray-300">{{ __('Presents optimized alternative via chatbot. Shows cost savings and justification. User decides to accept or reject.') }}</p>
                    </div>
                </div>
                ...
                <div class="mt-8 p-4 md:p-6 bg-blue-950/30 rounded-xl border border-blue-800">
                    ...
                    <div class="space-y-2 text-gray-300">
                        ...
                        <p class="text-blue-400 font-semibold">{{ __('Result: €45 saved + free shipping') }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-12 md:py-20 px-4 sm:px-6 lg:px-8 bg-gray-900">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-gray-800 rounded-2xl p-4 md:p-8 border border-gray-700">
                ...
                <h3 class="text-lg md:text-xl font-bold text-white mb-6">{{ __('Key Components') }}:</h3>

                <div class="grid md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        <h4 class="font-semibold text-white">{{ __('Integration Layer') }}</h4>
                        <div class="space-y-3">
                            <div class="flex items-center gap-3 p-3 bg-gray-900 rounded-lg">
                                <x-heroicon-o-server class="w-5 h-5 text-blue-400" />
                                <span class="text-gray-300">{{ __('Read-only ERP API/Database Access') }}</span>
                            </div>
                            <div class="flex items-center gap-3 p-3 bg-gray-900 rounded-lg">
                                <x-heroicon-o-document class="w-5 h-5 text-blue-400" />
                                <span class="text-gray-300">{{ __('PDF Policy Parser') }}</span>
                            </div>
                            <div class="flex items-center gap-3 p-3 bg-gray-900 rounded-lg">
                                <x-heroicon-o-arrow-path class="w-5 h-5 text-blue-400" />
                                <span class="text-gray-300">{{ __('Real-time Data Sync') }}</span>
                            </div>
                        </div>
                    </div>

                    <div class="space-y-4">
                        <h4 class="font-semibold text-white">{{ __('User Interface') }}</h4>
                        <div class="space-y-3">
                            <div class="flex items-center gap-3 p-3 bg-gray-900 rounded-lg">
                                <x-heroicon-o-chat-bubble-left-right class="w-5 h-5 text-blue-400" />
                                <span class="text-gray-300">{{ __('Web-based Chatbot Widget') }}</span>
                            </div>
                            <div class="flex items-center gap-3 p-3 bg-gray-900 rounded-lg">
                                <x-heroicon-o-chart-bar class="w-5 h-5 text-blue-400" />
                                <span class="text-gray-300">{{ __('Reporting Dashboard') }}</span>
                            </div>
                            <div class="flex items-center gap-3 p-3 bg-gray-900 rounded-lg">
                                <x-heroicon-o-bell class="w-5 h-5 text-blue-400" />
                                <span class="text-gray-300">{{ __('Automated Notifications') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8 p-4 md:p-6 bg-blue-950/30 rounded-xl border border-blue-800">
                    ...
                    <ul class="space-y-2 text-gray-300">
                        <li class="flex items-start gap-2">
                            <x-heroicon-o-shield-check class="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" />
