...
@section('content')
    ...
    {{-- Featured Visual --}}
    <section class="py-8 md:py-12 px-4 sm:px-6 lg:px-8 bg-gray-950">
        <div class="max-w-7xl mx-auto">
            <div class="w-full rounded-2xl overflow-hidden bg-gradient-to-br from-blue-100 to-violet-100 from-blue-950/30 to-violet-950/30 p-4 md:p-8">
                <picture>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <span class="text-gray-300 ml-2">{{ __('E-Commerce Industry') }}</span>
                                </div>
                            </div>
                            <div class="flex items-start gap-3">
                                <x-heroicon-o-check-circle class="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" />
                                <div>
                                    ...
                                    <span class="text-gray-300 ml-2">{{ __('2 weeks') }}</span>
                                </div>
                            </div>
                            <div class="flex items-start gap-3">
                                <x-heroicon-o-check-circle class="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" />
                                <div>
                                    ...
                                    <span class="text-gray-300 ml-2">{{ __('Communication channel integration and service automation') }}</span>
                                </div>
                            </div>
                            <div class="flex items-start gap-3">
                                <x-heroicon-o-check-circle class="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" />
                                <div>
                                    ...
                                    <span class="text-gray-300 ml-2">{{ __('Custom AI Agent (GPT-based)') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="py-12 md:py-20 px-4 sm:px-6 lg:px-8 bg-gray-950">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-gradient-to-br from-gray-800 to-gray-900/20 rounded-2xl p-4 md:p-8 border border-gray-700">
                ...
                <h3 class="text-lg md:text-xl font-bold text-white mb-4">{{ __('Main obstacles') }}:</h3>
                <ul class="space-y-3">
                    <li class="flex items-start gap-3">
                        <x-heroicon-o-x-circle class="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
                        <span class="text-gray-300">{{ __('Multiple communication channels without integration.') }}</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <x-heroicon-o-x-circle class="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
                        <span class="text-gray-300">{{ __('Delayed responses and low management consistency.') }}</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <x-heroicon-o-x-circle class="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
                        <span class="text-gray-300">{{ __('Lack of automation for basic questions and processes.') }}</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-gray-800 rounded-2xl p-8 border border-gray-700 mb-8">
                ...
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h3 class="text-lg md:text-xl font-bold text-white">{{ __('Implementation Stages') }}</h3>
                </div>
                ...
                <div class="space-y-6">
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="font-bold text-white mb-2">{{ __('Communication Flow Analysis') }}</h4>
                            <p class="text-gray-300">{{ __('Mapping the most frequent questions, request sources, and channels.') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="font-bold text-white mb-2">{{ __('Website AI Chatbot Development') }}</h4>
                            <p class="text-gray-300">{{ __('NLP-based dialogue integration for product, order, and shipping inquiries.') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="font-bold text-white mb-2">{{ __('Email Assistant (Mail API Integration)') }}</h4>
                            <p class="text-gray-300">{{ __('Automatic incoming classification, responses to recurring requests, and follow-up templates.') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="font-bold text-white mb-2">{{ __('Messaging Bots (Viber / WhatsApp API)') }}</h4>
                            <p class="text-gray-300">{{ __('Connection with messaging platforms for real-time automated responses.') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="font-bold text-white mb-2">{{ __('Central Integration via AI Agent (API Hub)') }}</h4>
                            <p class="text-gray-300">{{ __('All channels communicate with a single AI layer that learns, adapts, and updates staff.') }}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-12 md:py-20 px-4 sm:px-6 lg:px-8 bg-gray-950">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-gray-900 rounded-2xl p-4 md:p-8 border border-gray-700">
                ...
                <h3 class="text-lg md:text-xl font-bold text-white mb-6">{{ __('Technologies') }}:</h3>

                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div class="flex items-center gap-3 p-4 bg-gray-800 rounded-xl border border-gray-700">
                        <x-heroicon-o-cpu-chip class="w-6 h-6 text-blue-400" />
                        <span class="font-semibold text-white">OpenAI API</span>
                    </div>
                    <div class="flex items-center gap-3 p-4 bg-gray-800 rounded-xl border border-gray-700">
                        <x-heroicon-o-code-bracket class="w-6 h-6 text-blue-400" />
                        <span class="font-semibold text-white">Node.js</span>
                    </div>
                    <div class="flex items-center gap-3 p-4 bg-gray-800 rounded-xl border border-gray-700">
                        <x-heroicon-o-server class="w-6 h-6 text-blue-400" />
                        <span class="font-semibold text-white">RESTful APIs</span>
                    </div>
                    <div class="flex items-center gap-3 p-4 bg-gray-800 rounded-xl border border-gray-700">
                        <x-heroicon-o-shopping-cart class="w-6 h-6 text-blue-400" />
                        <span class="font-semibold text-white">PrestaShop</span>
                    </div>
                    <div class="flex items-center gap-3 p-4 bg-gray-800 rounded-xl border border-gray-700">
                        <x-heroicon-o-envelope class="w-6 h-6 text-blue-400" />
                        <span class="font-semibold text-white">Brevo</span>
                    </div>
                    <div class="flex items-center gap-3 p-4 bg-gray-800 rounded-xl border border-gray-700">
                        <x-heroicon-o-shield-check class="w-6 h-6 text-blue-400" />
                        <span class="font-semibold text-white">Secure Hosting</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-12 md:py-20 px-4 sm:px-6 lg:px-8 bg-gray-900">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-gray-800 rounded-2xl p-4 md:p-6 border border-gray-700">
                    <div class="flex items-center gap-3 mb-4">
                        <x-heroicon-o-calendar class="w-8 h-8 text-blue-400" />
                        <h3 class="text-lg md:text-xl font-bold text-white">{{ __('Goal') }}</h3>
                    </div>
                    <p class="text-3xl font-bold text-gray-300">{{ __('2 weeks timeline') }}</p>
                </div>

                <div class="bg-gray-800 rounded-2xl p-4 md:p-6 border border-gray-700">
                    <div class="flex items-center gap-3 mb-4">
                        <x-heroicon-o-chat-bubble-left-ellipsis class="w-8 h-8 text-blue-400" />
                        <h3 class="text-lg md:text-xl font-bold text-white">{{ __('Phases') }}</h3>
                    </div>
                    <p class="text-gray-300">{{ __('Analysis → Design → Development → Integration → Testing') }}</p>
                </div>

                <div class="bg-gray-800 rounded-2xl p-4 md:p-6 border border-gray-700">
                    <div class="flex items-center gap-3 mb-4">
                        <x-heroicon-o-arrow-path class="w-8 h-8 text-blue-400" />
                        <h3 class="text-lg md:text-xl font-bold text-white">{{ __('Maintenance') }}</h3>
                    </div>
                    <p class="text-gray-300">{{ __('Continuous performance monitoring and monthly AI retraining.') }}</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 md:py-20 px-4 sm:px-6 lg:px-8 bg-gray-950">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-gradient-to-br from-gray-900 to-gray-950 from-gray-950 to-black rounded-2xl p-6 md:p-12 border border-gray-700">
