...
@section('content')
    ...
    {{-- Features Section --}}
    <section id="services" class="py-20 px-4 sm:px-6 lg:px-8 bg-gray-950">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                {{-- Feature 4 --}}
                <div class="p-8 rounded-2xl bg-gradient-to-br from-emerald-950/30
                to-emerald-900/20 border border-emerald-800 hover:shadow-xl transition-all hover:-translate-y-1">
                ...
                {{-- Feature 5 --}}
                <div class="p-8 rounded-2xl bg-gradient-to-br from-amber-950/30
                to-amber-900/20 border border-amber-800 hover:shadow-xl transition-all hover:-translate-y-1">
    ...
    <section id="solutions" class="py-20 px-4 sm:px-6 lg:px-8 bg-gray-900">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                {{-- Solution 1 --}}
                <div class="bg-gray-800 rounded-2xl p-6 md:p-8 border border-gray-700 hover:shadow-xl transition-all">
                ...
                <div class="space-y-8">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        ...
                        <a
                            ...
                            class="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-gray-200 bg-gray-800 rounded-lg hover:bg-gray-700 transition-all border border-gray-700 shadow-lg"
                        >
                    ...
                    <div class="grid sm:grid-cols-2 gap-4 pt-4">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <h4 class="font-semibold text-white">{{ __('Real-time Analytics') }}</h4>
                                <p class="text-sm text-gray-400">{{ __('Live performance metrics') }}</p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-3">
                            <x-heroicon-o-check-circle class="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" />
                            <div>
                                <h4 class="font-semibold text-white">{{ __('Cost Tracking') }}</h4>
                                <p class="text-sm text-gray-400">{{ __('Monitor API usage & costs') }}</p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-3">
                            <x-heroicon-o-check-circle class="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" />
                            <div>
                                <h4 class="font-semibold text-white">{{ __('Performance Alerts') }}</h4>
                                <p class="text-sm text-gray-400">{{ __('Get notified of issues') }}</p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-3">
                            <x-heroicon-o-check-circle class="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" />
                            <div>
                                <h4 class="font-semibold text-white">{{ __('Easy Management') }}</h4>
                                <p class="text-sm text-gray-400">{{ __('Intuitive interface') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative group/mockup">
                    ...
                    md:[transform:perspective(1500px)_rotateY(-10deg)_rotateX(5deg)_translateZ(0)]">
                        ...
                        <div class="bg-gray-900 px-4 py-2 flex items-center space-x-2">
                            ...
                            {{-- URL Bar --}}
                            <div class="flex-1 mx-4 px-4 py-1 bg-gray-950 rounded-md text-sm text-gray-300 truncate">
                                demo.{{ config('app.name', 'aiagents') }}.com
                            </div>
                        </div>

                        {{-- Dashboard Screenshot/Content --}}
                        <div class="bg-gray-900 px-4 py-2 overflow-hidden">
                            <img
    ...
    {{-- Process Section --}}
    <section id="how-we-work" class="py-20 px-4 sm:px-6 lg:px-8 bg-gray-950">
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-16">
                <h2 class="text-4xl md:text-5xl font-bold mb-4 text-white">
                    {{ __('Our Process') }}
    ...
    <section id="case-studies" class="py-20 px-4 sm:px-6 lg:px-8 bg-gray-900">
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-16">
                <h2 class="text-4xl md:text-5xl font-bold mb-4 text-white">
                    {{ __('Case Studies') }}
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <a href="{{ localized_route('case-studies.' . $caseStudy['slug']) }}" class="group">
                    <div class="bg-gray-800 rounded-2xl p-8 border border-gray-700 hover:shadow-xl transition-all hover:-translate-y-1 h-full flex flex-col">
                        <div class="mb-4">
                            <span class="inline-block px-3 py-1 text-xs font-semibold rounded-full bg-blue-900 text-blue-200">
                    ...
                    <div x-data="{ active: false }" @click.outside="active = false" class="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden shadow-lg hover:shadow-xl transition-all">
                        ...
                        text-left focus:outline-none hover:bg-gray-700 transition-colors">
                            ...
                            <x-heroicon-s-chevron-down
                                class="w-5 h-5 text-gray-400 shrink-0 ml-3 transition-transform duration-200"
                                x-bind:class="active ? 'rotate-180' : ''"
                            />
                        </button>
                        <div x-show="active" class="overflow-hidden">
                            <div class="px-6 pb-4 text-sm text-gray-300 leading-relaxed">
