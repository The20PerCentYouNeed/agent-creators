        ...
        <div class="relative max-w-4xl mx-auto text-center">
            ...
            <div class="mb-10">
                ...
                <div class="flex flex-wrap justify-center gap-6">
                    <a href="mailto:info@eliaskalyvas.gr" class="inline-flex items-center gap-2 px-6 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg text-blue-200 hover:text-white hover:bg-white/20 transition-all">
