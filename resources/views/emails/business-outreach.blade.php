              ...
              <tbody>
                <tr>
                  <td align="center" style="text-align:center">
                    <a href="{{ config('app.url') }}" target="_blank" rel="noopener noreferrer" style="display:inline-block;text-decoration:none;vertical-align:middle">
                      <img
                        alt="{{ config('app.name') }}"
                        height="auto"
                    ...
                    <a href="{{ config('app.url') }}" target="_blank" rel="noopener noreferrer" style="display:inline-block;text-decoration:none;vertical-align:middle;margin-left:10px">
                      <img
                        alt="{{ config('app.name') }}"
                        height="auto"
                              ...
                              <tbody>
                                <tr>
                                  <td align="center" style="text-align:center;padding:0 10px">
                                    <a
                                      href="{{ config('services.social.facebook', 'https://www.facebook.com/share/1Ha6tZL77q/') }}"
                                      target="_blank"
                                  ...
                                  <td align="center" style="text-align:center;padding:0 10px">
                                    <a
                                      href="{{ config('services.social.linkedin', 'https://www.linkedin.com/company/noctua-core-system') }}"
                                      target="_blank"
                                      rel="noopener noreferrer"
                                      style="text-decoration:none;display:inline-block;max-width:100%"
