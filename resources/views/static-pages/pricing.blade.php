    ...
    <section class="pb-16 md:pb-20 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto space-y-8 md:space-y-12">
            ...
            <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-8 mt-12">
                ...
                {{-- Custom AI Chatbot --}}
                <div class="bg-gradient-to-br from-blue-950/30 to-violet-950/30 rounded-2xl p-6 md:p-8 border border-blue-800 shadow-lg hover:shadow-xl transition-all">
                    <div class="flex items-center gap-x-3 mb-6">
                        ...
                        <h3 class="text-lg md:text-xl font-bold text-white leading-tight">
                    ...
                    <div class="space-y-3 mb-6">
                        <h4 class="font-semibold text-white">{{ __('Deliverables:') }}</h4>
                    ...
                    <div class="border-t border-blue-700 pt-6">
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-gray-400">{{ __('Implementation Cost:') }}</span>
                            <span class="text-lg font-bold text-blue-600">1.500 € - 2.000 €</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-gray-400">{{ __('Monthly Support & Monitoring:') }}</span>
                            <span class="text-base font-semibold text-white">150 €/{{ __('month') }}</span>
                        </div>
                    </div>
                </div>

                {{-- AI Agent for Email Integration --}}
                <div class="bg-gradient-to-br from-violet-950/30 to-pink-950/30 rounded-2xl p-6 md:p-8 border border-violet-800 shadow-lg hover:shadow-xl transition-all">
                    <div class="flex items-center gap-x-3 mb-6">
                    ...
                    <div class="border-t border-violet-700 pt-6">
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-gray-400">{{ __('Implementation Cost:') }}</span>
                            <span class="text-lg font-bold text-violet-600">2.500 € - 3.500 €</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-gray-400">{{ __('Live Tuning Support:') }}</span>
                            <span class="text-base font-semibold text-white">200 €/{{ __('month') }}</span>
                        </div>
                    </div>
                </div>

                {{-- Custom Pricing Section --}}
                <div class="bg-gradient-to-br to-gray-100 from-gray-800/30 to-gray-900/30 rounded-2xl p-6 md:p-8 border border-gray-700 shadow-lg hover:shadow-xl transition-all md:col-span-2 xl:col-span-1">
                    <div class="flex items-center gap-x-3 mb-6">
                        <div class="w-10 h-10 bg-gray-700 bg-gray-600 rounded-lg flex items-center justify-center flex-shrink-0">
                            <svg class="w-5 h-5 text-gray-900" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="border-t border-gray-600 pt-6">
                        <div class="text-center">
                            <p class="text-sm font-medium text-gray-400 mb-2">{{ __('Completely Custom Solution') }}</p>
                            <a href="{{ localized_route('contact') }}" class="text-lg font-bold text-white">{{ __('Contact Us for Quote') }}</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-gradient-to-br from-green-950/30 to-blue-950/30 rounded-2xl p-6 md:p-8 border border-green-800 shadow-lg mt-12">
                <div class="flex items-center gap-x-3 mb-6">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        <h4 class="font-semibold text-white mb-3">{{ __('What You Get:') }}</h4>
                        <ul class="space-y-2 text-sm text-gray-300">
                            <li class="flex items-start">
                    ...
                    <div>
                        <h4 class="font-semibold text-white mb-3">{{ __('Implementation Timeline:') }}</h4>
                        <ul class="space-y-2 text-sm text-gray-300">
                            <li class="flex items-start">
                                <span class="mr-2 text-blue-600">•</span>
