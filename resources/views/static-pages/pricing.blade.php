    ...
    <section class="pb-16 md:pb-20 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto space-y-8 md:space-y-12">
            ...
            <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-8 mt-12">
                ...
                <div class="bg-gradient-to-br from-gray-800/30 to-gray-900/30 rounded-2xl p-6 md:p-8 border border-gray-700 shadow-lg hover:shadow-xl transition-all md:col-span-2 xl:col-span-1">
                    <div class="flex items-center gap-x-3 mb-6">
