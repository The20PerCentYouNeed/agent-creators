    ...
    <section class="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div class="relative max-w-5xl mx-auto text-center">
            ...
            <div class="flex flex-col items-center mb-6 md:flex-row md:items-center md:justify-center md:mb-8 md:space-x-3">
                ...
                <h1 class="text-2xl md:text-5xl font-bold text-white text-center">
                    {{ __('Documentation AI Agents') }}
                </h1>
            </div>

            <p class="text-base md:text-xl text-gray-400 max-w-3xl mx-auto mb-12">
            ...
            <div class="relative">
                ...
                <div class="space-y-3">
                    <div class="flex items-start space-x-3">
                        <svg class="w-6 h-6 text-gray-400 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                {{-- API Example --}}
                <p class="text-sm md:text-base font-semibold text-white mt-8 mb-3">
                    {{ __('API Call Example:') }}
                </p>
                <div class="bg-gray-800 rounded-lg p-4 font-mono text-xs md:text-sm overflow-x-auto">
                    <pre class="text-gray-200"><code>POST /agent/integrations
{
"type": "email",
